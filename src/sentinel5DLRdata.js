...
async function fetchDLRStacData(productKey) {
  ...
  const productName = {
    Formaldehyde: "S5P_TROPOMI_L3_P1D_HCHO",
    SulfurDioxide: "S5P_TROPOMI_L3_P1D_SO2",
    Ozone: "S5P_TROPOMI_L3_P1D_O3",
    AerosolIndex: "S5P_TROPOMI_L3_P1D_AI",
    NitrogenDioxide: "S5P_TROPOMI_L3_P1D_NO2",
    Methane: "S5P_TROPOMI_L3_P1D_CH4",
    CarbonMonoxide: "S5P_TROPOMI_L3_P1D_CO",
  };
